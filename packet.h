...
class packet {
  ...
  int team_id;			// the assigned team identification
	...
	String gps_time;			// the time generated by the GPS receiver. The time must be reported in UTC and have a resolution of a second. UTC Format: MM/dd/yyyy KK:mm:ss a
