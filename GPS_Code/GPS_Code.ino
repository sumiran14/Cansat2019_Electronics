...
void loop()
{
 // static const double LONDON_LAT = 51.508131, LONDON_LON = -0.128002;
  ...
  printFloat(gps.hdop.hdop(), gps.hdop.isValid(), 6, 1);                                    //Printing the received data    
  ...
  printInt(gps.location.age(), gps.location.isValid(), 5);                                  //Printing the received data - 
  ...
  printFloat(gps.course.deg(), gps.course.isValid(), 7, 2);                                 //Printing the received data - 
  printFloat(gps.speed.kmph(), gps.speed.isValid(), 6, 2);                                  //Printing the received data
  printStr(gps.course.isValid() ? TinyGPSPlus::cardinal(gps.course.deg()) : "*** ", 6);     //Printing the received data
